    ...
    <div class="shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="u_cat_name" value="<?php echo $display['cat_name']; ?>">
            </div>
            <div class="form-group">
                <label for="text">Category Type</label>
                <input type="text" class="form-control" name="u_cat_des" value="<?php echo $display['cat_des']; ?>">
            </div>
            <input type="hidden" name="idno" value=" <?php echo $display['cat_id']; ?>" > 
