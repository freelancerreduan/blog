    ...
    <table class="table">
        ...
        <tbody>
            <?php while($view_info = mysqli_fetch_assoc($view_category)){ ?>
             <tr>
                <th scope="row"><?php echo $view_info['cat_id']; ?></th>
                <td><?php echo $view_info['cat_name']; ?></td>
                <td><?php echo $view_info['cat_des']; ?></td>
                <td> 
                    <a href="edit_cat.php?status=edit&&id=<?php echo $view_info['cat_id']; ?>" class="btn btn-success">Edit</a>
                    <a href="?status=delete&&id=<?php echo $view_info['cat_id']; ?>" class="btn btn-danger">Delete</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
